    ...
    public class BGWalksDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var regions = new List<RegionDomain>(){
                new RegionDomain{Id = Guid.Parse("6d9a5989-5262-4403-8998-a4075088c650"), Name = "Rusafa", RegionImageUrl = "https://example.com/north-america.jpg"},
                new RegionDomain{Id = Guid.Parse("4459f691-b307-4543-8765-1413477a6b84"), Name = "Karkh", RegionImageUrl = "https://example.com/south-america.jpg"},
